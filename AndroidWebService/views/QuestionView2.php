...
$question1 = new Question(1, 'Người lái xe phải giảm tốc độ thấp hơn tốc độ tối đa cho phép (có thể dừng lại một cách an toàn) trong trường hợp nào dưới đây?', 'A. Khi có báo hiệu cảnh báo nguy hiểm hoặc có chướng ngại vật trên đường; khi chuyển hướng xe chạy hoặc tầm nhìn bị hạn chế; khi qua nơi đường giao nhau, nơi đường bộ giao nhau với đường sắt; đường vòng; đường có địa hình quanh co, đèo dốc.', 'B. Khi qua cầu, cống hẹp; khi lên gần đỉnh dốc, khi xuống dốc, khi qua trường học, khu đông dân cư, khu vực đang thi công trên đường bộ; hiện trường xảy ra tai nạn giao thông.', 'C. Khi điều khiển xe vượt xe khác trên đường quốc lộ, đường cao tốc.', 'D. Cả ý 1 và ý 2.', 4);
$question2 = new Question(2, 'Khi lái xe trên đường trơn, bạn nên:', 'A. Tăng tốc độ để đi qua nhanh', 'B. Giữ tốc độ ổn định và tuân thủ quy tắc giao thông', 'C. Sử dụng điện thoại di động', 'D. Không cần chú ý đến tình hình giao thông', 2);
$question3 = new Question(3, 'Khi lái xe trên đường cao tốc, bạn nên:', 'A. Giảm tốc độ để đảm bảo an toàn', 'B. Tăng tốc độ để vượt qua xe khác', 'C. Không chú ý đến biển báo', 'D. Sử dụng đèn chiếu sáng', 1);
$question4 = new Question(4, 'Khi gặp biển báo hạn chế tốc độ, bạn nên:', 'A. Tăng tốc độ để nhanh chóng vượt qua biển báo', 'B. Tuân thủ giới hạn tốc độ được quy định', 'C. Không chú ý đến biển báo', 'D. Sử dụng điện thoại di động', 2);
$question5 = new Question(5, 'Trên đoạn đường hai chiều không có giải phân cách giữa, người lái xe không được vượt xe khác trong các trường hợp nào dưới đây?', 'A. Xe bị vượt bất ngờ tăng tốc độ và cố tình không nhường đường.', 'B. Xe bị vượt giảm tốc độ và nhường đường.', 'C. Phát hiện có xe đi ngược chiều.', 'D. Cả ý 1 và ý 3.', 4);
...
$question21 = new Question(21, 'Khi đang lên dốc người ngồi trên xe mô tô có được kéo theo người đang điều khiển xe đạp hay không?', 'A. Chỉ được phép nếu cả hai đội mũ bảo hiểm.', 'B. Không được phép.', 'C. Chỉ được thực hiện trên đường thật vắng.', 'D. Chỉ được phép khi người đi xe đạp đã quá mệt.', 2);
