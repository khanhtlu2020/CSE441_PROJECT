...
$question1 = new Question(1, 'Khi lái xe trên đường cao tốc, bạn nên:', 'A. Giảm tốc độ để đảm bảo an toàn', 'B. Tăng tốc độ để vượt qua xe khác', 'C. Không chú ý đến biển báo', 'D. Sử dụng đèn chiếu sáng', 1);
$question2 = new Question(2, 'Khi lái xe vào ban đêm, bạn nên:', 'A. Sử dụng đèn chiếu sáng', 'B. Tắt đèn định vị GPS', 'C. Tăng tốc độ để nhanh chóng đến nơi', 'D. Không chú ý đến tình hình giao thông', 1);
$question3 = new Question(3, 'Khi lái xe trong khu vực đô thị, bạn nên:', 'A. Tăng tốc độ để vượt qua các xe khác', 'B. Giữ tốc độ ổn định và tuân thủ quy tắc giao thông', 'C. Sử dụng còi để cảnh báo người đi bộ', 'D. Đi ngược chiều trên đường một chiều', 2);
$question4 = new Question(4, 'Khi lái xe trên đường với mưa phùn, bạn nên:', 'A. Tăng tốc độ để nhanh chóng đến nơi', 'B. Giữ khoảng cách an toàn với các xe khác', 'C. Sử dụng đèn pha', 'D. Không chú ý đến tình hình giao thông', 2);
$question5 = new Question(5, 'Khi lái xe trên đường có điểm giao nhau, bạn nên:', 'A. Tăng tốc độ để nhanh chóng đi qua', 'B. Giảm tốc độ và quan sát trước khi đi qua', 'C. Không cần chú ý đến tình hình giao thông', 'D. Sử dụng còi để cảnh báo', 2);
...
$question21 = new Question(21, 'Các phương tiện tham gia giao thông đường bộ (kể cả những xe có quyền ưu tiên) đều phải dừng lại bên phải đường của mình và trước vạch “dừng xe” tại các điểm giao cắt giữa đường bộ và đường sắt khi có báo hiệu dừng nào dưới đây?', 'A. Hiệu lệnh của nhân viên gác chắn.', 'B. Đèn đỏ sáng nháy, cờ đỏ, biển đỏ.', 'C. Còi, chuông kêu, chắn đã đóng.', 'D. Tất cả các ý trên.', 4);
$question22 = new Question(22, 'Người đủ 16 tuổi được điều khiển các loại xe nào dưới đây?', 'A. Xe mô tô 2 bánh có dung tích xi lanh từ 50 cm³ trở lên.', 'B. Xe gắn máy có dung tích xi lanh dưới 50 cm³.', 'C. Xe ô tô tải dưới 3,5 tấn; xe chở người đến 9 chỗ ngồi.', 'D. Tất cả các ý nêu trên.', 2);
$question23 = new Question(23, 'Khi đang lên dốc người ngồi trên xe mô tô có được kéo theo người đang điều khiển xe đạp hay không?', 'A. Chỉ được phép nếu cả hai đội mũ bảo hiểm.', 'B. Không được phép.', 'C. Chỉ được thực hiện trên đường thật vắng.', 'D. Chỉ được phép khi người đi xe đạp đã quá mệt.', 2);
$question24 = new Question(24, 'Khi lái xe trong khu vực đô thị, bạn nên:', 'A. Tăng tốc độ để vượt qua các xe khác', 'B. Giữ tốc độ ổn định và tuân thủ quy tắc giao thông', 'C. Sử dụng còi để cảnh báo người đi bộ', 'D. Đi ngược chiều trên đường một chiều', 2);
$question25 = new Question(25, 'Biển báo nào chỉ dẫn nơi đỗ xe?', 'A. Biển 1', 'B. Biển 2', 'C. Biển 3', 'D. Biển 4', 1);
